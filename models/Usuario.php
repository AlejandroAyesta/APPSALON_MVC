...
class Usuario extends ActiveRecord {
    ...
    // Mensajes de validación al crear una cuenta
    ...
    public function comprobarCampos($password) {
        $resultado = password_verify($password, $this->password);

        if(!$resultado || !$this->confirmado) {
            self::$alertas['error'][] = 'Contraseña incorrecta o tu cuenta no está confirmada';
        } else {
            return true;
        }
    }
